/*
Flatten a LayerCluster to SimCluster association map
...
public:
  ...
  // constructor
  explicit FlattenLCToSCAssociator(edm::ParameterSet const& cfg)
  {
               ...
               edm::EventSetup const&) const override
  {
    ...
    event.put(std::move(cpIdx), destName_ + "SCIdx");
...
DEFINE_FWK_MODULE(FlattenLCToSCAssociator);
