...
def get_quantity_per_layer(df, column):
...
def get_purity_per_layer(df):
    return get_quantity_per_layer(df, 'pur')

def get_efficiency_per_layer(df):
    return get_quantity_per_layer(df, 'eff')
